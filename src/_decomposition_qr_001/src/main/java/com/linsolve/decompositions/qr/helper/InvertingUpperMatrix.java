...
import com.linsolve.decompositions.qr.components.basicoperations.*;
import com.linsolve.decompositions.qr.components.elementaryoperations.*;

public class InvertingUpperMatrix 
{
	...
	public InvertingUpperMatrix() 
	{
		super();
		// TODO Auto-generated constructor stub
	}

	public InvertingUpperMatrix(int index, int size) {
		super();
		this.index = index;
		this.size = size;
		this.initialMatrix=new Matrix(size,size);
		this.initialMatrix.setT(GeneratingRandomUpperMatrix.supplyRandomUpperMatrix(index, size).getT());
	...
	public InvertingUpperMatrix(Matrix initialMatrix) {
		super();
